...
export class GACFileService {
  ...
  NewDocument(ObjGac: GACFiledto) {
    ...
    return this.http.post(this.rootUrlII + "ArchiveAPI/NewDocumentArchive", this._ObjGac);
  }
  ...
  NewReferenceDocument(ObjGac: GACFiledto) {
    try {
      ...
      // Await the HTTP post by converting Observable to Promise

      return this.http.post(this.rootUrlII + "ArchiveAPI/NewReferenceDocument", this._ObjGac);
