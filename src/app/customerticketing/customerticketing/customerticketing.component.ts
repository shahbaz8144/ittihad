...
import { RoleDTO } from 'src/app/_models/role-dto';
...
@Component({
  selector: 'app-customerticketing',
  templateUrl: './customerticketing.component.html',
  styleUrls: ['./customerticketing.component.css']
})
export class CustomerticketingComponent implements OnInit {
